...
→該当行
売単価:<span class="data">1296</span>減算、
<br>
<br>
楽天・Yahoo:<br>
...
<div class="explain small">
対象商品: janコードが<span class="data">5000</span>、数量<span class="data">3</span>ごと
<br>
→行追加
...
<br>
　商品op:<span class="data">手数料にて割引。-</span><span class="meta">追加行の数量×1080</span><span class="data">円</span>
<br>
その他の手数料があったら、<br>
→商品op:
<span class="data">手数料にて割引。手数料内訳：その他 ○○円、ネクタイよりどり割引 -</span><span class="meta">追加行の数量×1080</span></span><span class="data">円</span>
<br>
　小計:<span class="data">0</span>
<br>
　手数料:<span class="meta">追加行の数量×1080</span>分減算（割引）
<br>
　総合計:再計算する
<br>
<br>
本店:<br>
→商品計:<span class="meta">追加行の数量×1080</span>分加算（FSは商品計だけ割引済みなので加算して補正）
<br>
<br>
楽天:<br>
→確認チェック:チェックを外す<br>
備考欄に<span class="data">■楽天バンク決済</span>があったら、<br>
→商品op:<span class="data">手数料にて割引。手数料内訳：楽天バンク決済 155円、ネクタイよりどり割引 -</span><span class="meta">追加行の数量×1080</span><span class="data">円</span>
<br>
　その他の手数料があったら、<br>
　商品op:<span class="data">手数料にて割引。手数料内訳：その他 </span><span class="meta">手数料-155</span><span class="data">円、楽天バンク決済 155円、ネクタイよりどり割引 -</span><span class="meta">追加行の数量×1080</span><span class="data">円</span>
<br>
　納品書特記事項:<br>
...
　他費用:<span class="meta" style="text-decoration:line-through;">追加行の数量×1080</span>分加算（Yahooは他費用で割引済みなので加算して補正）
</span>
<br>
<br>
</div>
